...
- [Mutation Observer API](#mutation-observer-api)
    - [概述](#概述)
    - [MutationObserver 构造函数](#mutationobserver-构造函数)
    - [MutationObserver 的实例方法](#mutationobserver-的实例方法)
        - [1. observe()](#1-observe)
        - [2. disconnect()，takeRecords（）](#2-disconnecttakerecords)
    - [MutationRecord 对象](#mutationrecord-对象)
    - [应用示例](#应用示例)
        - [1. 子元素的变动](#1-子元素的变动)
        - [2. 属性的变动](#2-属性的变动)
        - [3. 取代 DOMContentLoaded 事件](#3-取代-domcontentloaded-事件)
