...
- [Web Worker](#web-worker)
    ...
    - [API](#api)
        - [1. 主线程](#1-主线程)
        - [2. Worker 线程](#2-worker-线程)
    - [基本用法](#基本用法)
        - [1.  主线程](#1--主线程)
        - [2.  Worker 线程](#2--worker-线程)
        - [3. Worker 加载脚本](#3-worker-加载脚本)
        - [4. 错误处理](#4-错误处理)
        - [5. 关闭 Worker](#5-关闭-worker)
    - [数据通信](#数据通信)
    - [同页面的 Web Worker](#同页面的-web-worker)
    - [实例：Worker 线程完成轮询](#实例worker-线程完成轮询)
    - [实例： Worker 新建 Worker](#实例-worker-新建-worker)
